...
class PayrollMonth(Base):
    ...
    medical = Column(Numeric(10, 2), nullable=False, default=0)            # paid earning, in gross (Session 22)
    ...
    income_tax = Column(Numeric(10, 2), nullable=False, default=0)         # manual monthly deduction (Session 22)
    nps = Column(Numeric(10, 2), nullable=False, default=0)                # manual monthly deduction (Session 22)
    total_deduction = Column(Numeric(10, 2), Computed("((((((pf_emp + esic_emp) + pt) + loan_emi) + other_deduction) + ld) + income_tax + nps)", persisted=True))
